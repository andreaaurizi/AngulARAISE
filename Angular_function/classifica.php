<?php
/**
 * Returns the list of users ordered by win.
 */
require 'database.php';

$users = [];
$sql = "SELECT id, username, email, password, nome, cognome, clan, win, lost, img_profile, logged, status FROM user ORDER BY win DESC";
